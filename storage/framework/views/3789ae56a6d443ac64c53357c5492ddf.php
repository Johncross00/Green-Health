<?php $__env->startSection('title', 'Code de verification'); ?>
<?php $__env->startSection('body-container'); ?>
    ...
    <div class="login-container d-flex justify-center justify-content-center align-content-center align-items-center">
        <div class="login-card">
            ...
            <form method="post" action="<?php echo e(route('email.code')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($email ?? old('email')); ?>" name="email" id="email"
...
<?php echo $__env->make('layouts.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/bons/resources/views/authentification/code.blade.php ENDPATH**/ ?>