                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="bi bi-person icon-orange me-2"></i>
                                    <?php echo e(optional($op->user)->nom . ',' . optional($op->user)->prenom ?: 'Utilisateur non trouvé'); ?>

                                </td>
                                <td><i class="bi bi-envelope icon-orange me-2"></i>
                                    <?php echo e(optional($op->user)->email ?: 'Email non disponible'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\35-Sant--main\resources\views/operateurs/list.blade.php ENDPATH**/ ?>