...
<body style="@keyframes rotate {
    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 8px;">
        <div class="text-center" style="text-align:center;">
            <img src="<?php echo e($message->embed(public_path('assets/images/logo-bonr.png'))); ?>" alt="image" style="width: 100px; height: 100px; animation: rotate 5s linear infinite;"/>
        </div>
        <div style="padding: 20px;">
            ...
            <div class="code" style="font-size: 24px; font-weight: bold; text-align: center; padding: 20px; background-color: #f8f9fa; border-radius: 8px; margin: 20px 0; border: 1px solid #ddd;"><?php echo e($code); ?></div>
...
<?php /**PATH /home/sparqrqm/public_html/bons/resources/views/authentification/reset_password.blade.php ENDPATH**/ ?>