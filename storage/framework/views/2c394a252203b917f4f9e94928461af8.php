                                ...
                                <?php
                                    ...
                                    if ($user->transactions->count()) {
                                        foreach ($user->transactions as $trans) {
                                            if ($trans->bon && Carbon::parse($trans->bon->date)->lt($now)) {
                                                $use += 1;
                                            }
                                        }
                                    }
...
<?php /**PATH C:\Users\PAVILION\Pictures\Samsung Flow\archive\public_html\resources\views/components/client-dashboard.blade.php ENDPATH**/ ?>