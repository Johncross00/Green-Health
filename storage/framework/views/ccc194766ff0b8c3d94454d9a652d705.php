        ...
        <div class="modal-dialog">
            <div class="modal-content modal-card">
                ...
                <div class="modal-body">
                    ...
                    <!-- Section Green -->
                    <form class="green-form" action="<?php echo e(route('cash')); ?>" method="POST">
                    ...
                    <div id="green-section" class="withdraw-section show">
                        <div class="mb-3">
                            ...
                            <input type="text" value="<?php echo e(Auth::user()->numero_reseau); ?>" readonly class="form-control" id="transactionNumber" placeholder="Entrez le numéro" required>
                        </div>
                        <div class="mb-3">
...
<?php /**PATH C:\Users\PAVILION\Pictures\Samsung Flow\archive\public_html\resources\views/coupons/retrait.blade.php ENDPATH**/ ?>