...
<div class="container-fluid">
    <div class="row row-cols-1 row-cols-md-4">
        <?php $__currentLoopData = $cardData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col rounded-0">
            <div class="card rounded-0 shadow-none border-0"style="background:rgba(245,251,252,1);" >
                <div class="card-header w-100 h-100  px-1 py-1 rounded">
                    <img class="w-100 h-100" src="<?php echo e(asset('assets/images/vecteur' . ($index + 1) . '.jpg')); ?>" alt="vecteur">
                </div>
                <div class="card-body w-100 h-100 px-0">
                    <p class="px-0"><?php echo e($data['description']); ?></p>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/sparqrqm/public_html/bons/resources/views/components/list-scroll.blade.php ENDPATH**/ ?>