...
<div class="side-container-bg d-flex justify-content-center align-items-center ">
    <div class="container py-4">
        ...
        <div
            ...
            <h1 class="fs-4 fw-bold mb-2 mb-sm-0 text-warning">Bienvenue Commercial <?php echo e(Auth::user()->pseudo); ?></h1>
            ...
            <div class="col">
                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h3 class="action-title fs-5 fw-semibold text-center">BONS REÇUS</h3>
                    </div>
                </div>
                </a>
            </div>
                ...
                <a data-bs-toggle="modal" data-bs-target="#userTransferModal">
                    <div class="card h-100">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                            ...
                            <h3 class="action-title fs-5 fw-semibold text-center">HISTORIQUE DES BONS REÇUS</h3>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a data-bs-toggle="modal" data-bs-target="#historyModal">
                    <div class="card h-100">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                            ...
                            <h3 class="action-title fs-5 fw-semibold text-center">HISTORIQUE DES RETRAITS</h3>
                        </div>
                    </div>
                </a>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\35-Sant--main\resources\views/partenaires/partenaire_index.blade.php ENDPATH**/ ?>