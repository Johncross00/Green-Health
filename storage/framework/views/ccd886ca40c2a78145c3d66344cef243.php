                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="bi bi-person icon-orange me-2"></i>
                                    <?php echo e(optional($partenaire->user)->nom . ',' . optional($partenaire->user)->prenom ?: 'Utilisateur non trouvé'); ?>

                                </td>
                                <td><i class="bi bi-envelope icon-orange me-2"></i>
                                    <?php echo e(optional($partenaire->user)->email ?: 'Email non disponible'); ?>

                                </td>
                                <td><i class="bi bi-geo-alt icon-orange me-2"></i>
                                    <?php echo e($partenaire->location); ?>

                                </td>
                                <td><i class="bi bi-credit-card icon-orange me-2"></i>
                                    <?php echo e($partenaire->identifiant); ?>

                                </td>
                                <td><i class="bi bi-coin icon-orange me-2"></i>
                                    <?php echo e($partenaire->balance); ?>Gr
                                </td>
                                <td>
                                    <?php echo e($partenaire->commissions); ?>Gr
                                </td>
                                <td>
                                    <?php echo e($partenaire->status); ?>

                                </td>
                                <?php if($partenaire->status=='inactive'): ?>
                                <td>
                                    <form action="<?php echo e(route('post-activer-partenaire')); ?>" method="post">
                                        <?php echo method_field('POST'); ?>
                                        <?php echo csrf_field(); ?>
                                        <input required type="text" hidden name="partenaire" value="<?php echo e($partenaire->id); ?>">
                                        <button type="submit" class="btn btn-sm btn-activate">Activer</button>
                                    </form>
                                </td>
                                <?php else: ?>
                                <td>
                                    <form action="<?php echo e(route('post-deactiver-partenaire')); ?>" method="post">
                                        <?php echo method_field('POST'); ?>
                                        <?php echo csrf_field(); ?>
                                        <input required type="text" hidden name="partenaire" value="<?php echo e($partenaire->id); ?>">
                    ...
                    <div class="card mb-3 bg-light">
                        <div class="card-body">
                            <h5 class="card-title text-black"><i class="bi bi-person icon-orange me-2"></i>
                                <?php echo e($partenaire->user->nom .','.$partenaire->user->prenom); ?>

                            </h5>
                            <p class="card-text"><i class="bi bi-envelope icon-orange me-2"></i>
                                <?php echo e($partenaire->user->email); ?>
                            ...
                            <p class="card-text"><i class="bi bi-coin icon-orange me-2"></i>Balance:<?php echo e($partenaire->balance); ?>Gr | Commission: <?php echo e($partenaire->commissions); ?>Gr</p>
                            <div class="mt-3">
                                <?php if($partenaire->status=='inactive'): ?>
                                <form action="<?php echo e(route('post-activer-partenaire')); ?>" method="post">
                                    <?php echo method_field('POST'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\35-Sant--main\resources\views/partenaires/list.blade.php ENDPATH**/ ?>