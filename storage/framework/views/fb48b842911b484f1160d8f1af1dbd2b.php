...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['clients' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients),'qteT' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($qteT),'coupons' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($coupons),'bmsc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bmsc),'counts' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($counts),'qteV' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($qteV),'ventes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ventes)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php else: ?>
<?php echo $__env->make('clients.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sparqrqm/public_html/bons/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>