...
<div class="login-container d-flex justify-center justify-content-center align-content-center align-items-center">
  <div class="login-card">
      ...
      <form  method="post" action="<?php echo e(route('password.reset')); ?>" id="passwordForm">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vrtvjmeg/public_html/resources/views/authentification/password.blade.php ENDPATH**/ ?>