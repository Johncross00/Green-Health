                        ...
                        <div class="row g-3">
                            @foreach($coupons as $coupon)
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                                    <input type="radio" class="btn-check" name="bon_id" id="bon_{{ $coupon->id }}"
                                        value="{{ $coupon->id }}" required>
                                    <label class="btn btn-outline-primary w-100 h-100" for="bon_{{ $coupon->id }}">
                                        <div class="card h-100 position-relative border-0 shadow-sm {{ $coupon->quantite === 0 ? 'opacity-50' : '' }}"
                                            ...
                                            <div
                                                ...
                                                <div class="text-center">
                                                    <p class="mb-1 fs-6"><strong>{{ $coupon->quantite }}</strong> en stock
                                                    </p>
                                                    <p class="mb-0 fs-6 text-warning">
                                                        <strong>{{ number_format($coupon->price, 0, ',', ' ') }}</strong>
                                                        Fcfa</p>
                                                </div>
                                            </div>
                                        </div>
