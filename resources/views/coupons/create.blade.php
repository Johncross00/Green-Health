        ...
        <form class="form-container shadow-sm w-100" action="{{ route('bon-store') }}" method="post" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="price" placeholder="2000" name="price" min="0" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="negotiation_price">Prix de Négociation</label>
                <div class="input-group">
                    <span class="input-group-text"><i class=" bon-mdi mdi mdi-cash"></i></span>
                    <input type="number" class="form-control" id="negotiation_price" name="negotiation_price" placeholder="Prix de négociation" min="0">
                </div>
            </div>
            <div class="form-group">
                <label for="percentage">Pourcentage</label>
                <div class="input-group">
                    <span class="input-group-text"><i class=" bon-mdi mdi mdi-percent"></i></span>
                    <input type="number" class="form-control" id="percentage" name="percentage" placeholder="Pourcentage" min="0" max="100">
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const negotiationPrice = document.getElementById('negotiation_price');
        ...
        const errorMessages = {
            ...
            negotiation_price: 'Prix de négociation requis',
            percentage: 'Pourcentage requis'
        };
        ...
        const errorElements = {
            ...
            negotiation_price: createErrorElement(negotiationPrice),
            percentage: createErrorElement(percentage)
        };
        ...
        negotiationPrice.addEventListener('input', validateField);
        percentage.addEventListener('input', validateField);
        ...
        function validateField(event) {
            ...
            if (field === quantite || field === price || field === negotiationPrice || field === percentage) {
                isValid = value !== '' && Number(value) >= field.min && (field.max ? Number(value) <= field.max : true);
            } else {
                isValid = value !== '';
            }
        ...
        function validateForm(event) {
            ...
            if (!validateFieldAndReturn(negotiationPrice)) isValid = false;
            if (!validateFieldAndReturn(percentage)) isValid = false;
        ...
        function validateButtonState() {
            const isFormValid = price.classList.contains('is-valid') &&
                ...
                negotiationPrice.classList.contains('is-valid') &&
                percentage.classList.contains('is-valid');
